...
public class ParkController {
	...
	public VisitorData insertVisitor(@RequestBody VisitorData visitorData) {
		log.info("Creating visitor{}", visitorData);
		return parkService.saveVisitor(visitorData);
	}

	@PutMapping("/visitor/{visitorId}")
	public VisitorData updateVisitor(@PathVariable Long visitorId, @RequestBody VisitorData visitorData) {
	...
	public Map<String, String> deleteVisitorById(@PathVariable Long visitorId) {
	...
	@PostMapping("/visitor/{visitorId}/park")
	public ParkData insertNationalPark(@PathVariable Long visitorId,
			@RequestBody ParkData parkData){
